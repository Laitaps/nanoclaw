...
- once: Local time WITHOUT "Z" suffix (e.g., "2026-02-01T15:30:00")`,
  ...
  // NOTE: approve_pr and reject_pr tools live on the RA MCP server
  // (tools/pr_tools.py, port 8000) — NOT here. Goose and Claude agents
  // both connect to the RA server and can call them directly.
}
